...
Pickup::Pickup(int type)
{
	...
	// Associating the textures with the sprite
	if (m_Type == 1)
	{
	...
	else if (m_Type == 2)
	{
		...
		m_Sprite = Sprite(TextureHolder::GetTexture("graphics/freezeTime.png"));
	}
	else {
		m_Sprite = Sprite(TextureHolder::GetTexture("graphics/metal.png"));
	}
